...
//		entityRepository.saveAll(Arrays.asList(entity1, entity2, entity3, entity4));
		...
		entityService.createEntity(entity1, user1.getId());
		entityService.createEntity(entity2, user1.getId());
		entityService.createEntity(entity3, user1.getId());
		entityService.createEntity(entity4, user1.getId());
